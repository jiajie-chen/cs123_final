...
struct qt_meta_stringdata_Canvas3D_t {
    QByteArrayData data[1];
    char stringdata[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Canvas3D_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Canvas3D_t qt_meta_stringdata_Canvas3D = {
    {
...
void Canvas3D::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject Canvas3D::staticMetaObject = {
    { &SupportCanvas3D::staticMetaObject, qt_meta_stringdata_Canvas3D.data,
      qt_meta_data_Canvas3D,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Canvas3D.stringdata))
