...
<<<<<<< HEAD
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/CS1231.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/CS1231.0.0/ && $(COPY_FILE) --parents camera/OrbitingCamera.h camera/CamtransCamera.h camera/Camera.h scenegraph/SelectionRecorder.h lib/CS123XmlSceneParser.h lib/CS123SceneData.h lib/CS123ISceneParser.h lib/CS123Common.h lib/ResourceLoader.h scenegraph/ShapesScene.h scenegraph/SceneviewScene.h scenegraph/Scene.h scenegraph/OpenGLScene.h ui/SupportCanvas3D.h ui/Settings.h ui/mainwindow.h ui/Databinding.h ui/Canvas3D.h ui_mainwindow.h glew-1.10.0/include/GL/glew.h shape/OpenGLShape.h shape/Shape.h shape/CubeShape.h shape/CylinderShape.h lib/ErrorChecker.h shape/ConeShape.h shape/SphereShape.h .tmp/CS1231.0.0/ && $(COPY_FILE) --parents camera/OrbitingCamera.cpp camera/CamtransCamera.cpp scenegraph/SelectionRecorder.cpp lib/CS123XmlSceneParser.cpp lib/ResourceLoader.cpp scenegraph/ShapesScene.cpp scenegraph/SceneviewScene.cpp scenegraph/Scene.cpp scenegraph/OpenGLScene.cpp ui/SupportCanvas3D.cpp ui/Settings.cpp ui/mainwindow.cpp ui/Databinding.cpp ui/Canvas3D.cpp main.cpp glew-1.10.0/src/glew.c shape/OpenGLShape.cpp shape/Shape.cpp shape/CubeShape.cpp shape/CylinderShape.cpp lib/ErrorChecker.cpp shape/ConeShape.cpp shape/SphereShape.cpp .tmp/CS1231.0.0/ && $(COPY_FILE) --parents ui/mainwindow.ui .tmp/CS1231.0.0/ && (cd `dirname .tmp/CS1231.0.0` && $(TAR) CS1231.0.0.tar CS1231.0.0 && $(COMPRESS) CS1231.0.0.tar) && $(MOVE) `dirname .tmp/CS1231.0.0`/CS1231.0.0.tar.gz . && $(DEL_FILE) -r .tmp/CS1231.0.0
=======
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/CS1231.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/CS1231.0.0/ && $(COPY_FILE) --parents camera/OrbitingCamera.h camera/CamtransCamera.h camera/Camera.h scenegraph/SelectionRecorder.h lib/CS123XmlSceneParser.h lib/CS123SceneData.h lib/CS123ISceneParser.h lib/CS123Common.h lib/ResourceLoader.h scenegraph/ShapesScene.h scenegraph/SceneviewScene.h scenegraph/Scene.h scenegraph/OpenGLScene.h ui/SupportCanvas3D.h ui/SupportCanvas2D.h ui/Settings.h ui/mainwindow.h ui/Databinding.h ui/Canvas3D.h ui_mainwindow.h glew-1.10.0/include/GL/glew.h shape/OpenGLShape.h shape/Shape.h shape/CubeShape.h shape/CylinderShape.h lib/ErrorChecker.h shape/ConeShape.h shape/SphereShape.h camera/POVCamera.h .tmp/CS1231.0.0/ && $(COPY_FILE) --parents camera/OrbitingCamera.cpp camera/CamtransCamera.cpp scenegraph/SelectionRecorder.cpp lib/CS123XmlSceneParser.cpp lib/ResourceLoader.cpp scenegraph/ShapesScene.cpp scenegraph/SceneviewScene.cpp scenegraph/Scene.cpp scenegraph/OpenGLScene.cpp ui/SupportCanvas3D.cpp ui/SupportCanvas2D.cpp ui/Settings.cpp ui/mainwindow.cpp ui/Databinding.cpp ui/Canvas3D.cpp main.cpp glew-1.10.0/src/glew.c shape/OpenGLShape.cpp shape/Shape.cpp shape/CubeShape.cpp shape/CylinderShape.cpp lib/ErrorChecker.cpp shape/ConeShape.cpp shape/SphereShape.cpp camera/POVCamera.cpp .tmp/CS1231.0.0/ && $(COPY_FILE) --parents ui/mainwindow.ui .tmp/CS1231.0.0/ && (cd `dirname .tmp/CS1231.0.0` && $(TAR) CS1231.0.0.tar CS1231.0.0 && $(COMPRESS) CS1231.0.0.tar) && $(MOVE) `dirname .tmp/CS1231.0.0`/CS1231.0.0.tar.gz . && $(DEL_FILE) -r .tmp/CS1231.0.0
>>>>>>> 897c65d46ff84e51405344e39ab85fab323a02ea
...
compiler_moc_header_clean:
	-$(DEL_FILE) moc_SupportCanvas3D.cpp moc_mainwindow.cpp moc_Databinding.cpp moc_Canvas3D.cpp
...
POVCamera.o: camera/POVCamera.cpp camera/POVCamera.h \
		camera/Camera.h \
		lib/CS123Common.h \
		glew-1.10.0/include/GL/glew.h \
		/usr/include/qt5/QtWidgets/QMessageBox \
